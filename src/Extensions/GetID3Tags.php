...
class GetID3Tags extends DataExtension
{
    ...
    public function getTags($data, $form)
    {
        ...
        $getID3 = new GetID3;
        $file = $getID3->analyze(Director::publicFolder() . $record->Media()->getURL());
